import sys
from PyQt6.QtWidgets import QApplication, QMainWindow, QPushButton, QVBoxLayout, QWidget, QDialog, QLabel, QLineEdit, QComboBox, QSpinBox, QTextEdit
        ...
        if connection:
            try:
                ...
                if data:
                    ...
                    # You can add code here to handle successful login (e.g., open another page)
                else:
